...
namespace CyberGear.Client.ViewModels
{
    ...
    public class AppViewModel()
    {
        ...
        /// 软件版本
        /// </summary>
        public ReactiveProperty<string> AppVersion { get; set; } = new ReactiveProperty<string>();

        /// <summary>
        /// 应用标题—— 和 AppName不同，这个可以动态变更
        /// </summary>
        public ReactiveProperty<string> AppTitle { get; set; } = new ReactiveProperty<string>();
        ...
        /// 当前页面
        /// </summary>
        public ReactiveProperty<Page> CurrentPage { get; set; } = new ReactiveProperty<Page>();
